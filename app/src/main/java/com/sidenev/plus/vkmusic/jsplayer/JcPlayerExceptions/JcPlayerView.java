        ...
        public void onPaused() {
            if (Build.VERSION.SDK_INT >= Build.VERSION_CODES.JELLY_BEAN) {
                btnPlay.setBackground(ResourcesCompat.getDrawable(getResources(),
                        R.drawable.ic_play_arrow_black_24dp_dark, null));
            ...
            btnPlay.setTag(R.drawable.ic_play_arrow_black_24dp_dark);
        }
...
//            final String mTitle = title;
    ...
    private void init() {
        ...
        imageLoader1.loadImage(avatarView, "https://pp.userapi.com/c846124/v846124949/ac109/9gctDt2ZHhI.jpg", "");
